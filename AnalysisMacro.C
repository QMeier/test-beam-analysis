...
class PulseAnalyzer{
  ...
  public:
    ...
    void SetBranches(TString branchname){
       TBranch* channel_br;
       TBranch* time_br;
       TBranch* gaus_mean_br;
       TBranch* amp_br;
       ...
       main_tree->SetBranchStatus(branchname,1);
       ...
       main_tree->SetBranchAddress(branchname, gaus_mean, &gaus_mean_br);
    ...
    void SetGoodPulses(TString branchname){
  ...
  private:
   ...
   {
   	 RooRealVar Time("Time","Time",2.15, 2.70);
     RooRealVar Mean("Mean","Mean",2.2, 2.6);
     RooRealVar Sigma("Sigma","Sigma",0.050, 0.000, 1.000);
